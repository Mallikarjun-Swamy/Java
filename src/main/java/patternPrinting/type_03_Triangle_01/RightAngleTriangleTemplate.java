...
public class RightAngleTriangleTemplate {

    /*
    Rules.
    1. Outer loops acts as number of rows to be printed (n)

    2. Inner loop, acts as number elements to be printed is,
    should go from j (inner loop variable) to i (outer loop variable),
